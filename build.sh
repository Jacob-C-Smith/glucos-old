...
# C/C++ Compilation
i686-elf-gcc -m32 -std=gnu99 -ffreestanding -O2 -Wall -Wextra -I kernel/include/ -c kernel/source/kernel.c -o kernel/object/kernel.o 
i686-elf-gcc -m32 -std=gnu99 -ffreestanding -O2 -Wall -Wextra -I kernel/include/ -c kernel/source/string.c -o kernel/object/string.o 
...
# Link
i686-elf-gcc -m32 -I kernel/include/ -T .ld -o os.bin -ffreestanding -O2 -nostdlib \
